...
public class FilteredListenerTest {

    @Spy
    private FilteredListener filteredListener;

    private final EmbeddedKafkaBroker embeddedKafkaBroker;

    private Producer<String, String> producer;

    public FilteredListenerTest(EmbeddedKafkaBroker embeddedKafkaBroker) {
    ...
    @Test
    void testFilteredListener() throws Exception {
        // Send a test message
        String key = "test-key";
        ...
        verify(filteredListener, timeout(10000)).filteredListenr(value);

        System.out.println("[DEBUG_LOG] FilteredListener test passed successfully!");
    }
}