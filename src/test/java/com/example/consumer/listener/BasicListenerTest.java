...
public class BasicListenerTest {
    ...
    public BasicListenerTest(EmbeddedKafkaBroker embeddedKafkaBroker) {
    ...
    void testBasicListener() throws Exception {
        ...
        verify(basicListener, timeout(10000)).listener(value);

        System.out.println("[DEBUG_LOG] BasicListener test passed successfully!");
    }
}
